    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="#exams" data-tab="exams"><i class="fa fa-user-circle-o" aria-hidden="true"></i> Exams <span class="notification"> <span>
                    </a>
                </li>

                <li>
                    <a href="#results" data-tab="results"><i class="fa fa-cog" aria-hidden="true"></i> Results <span class="notification">
                    </a>
                </li>
            </ul>

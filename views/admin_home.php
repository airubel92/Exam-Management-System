    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="#manage-users" data-tab="manage-users"><i class="fa fa-user-circle-o" aria-hidden="true"></i> Manage Users </a>
                </li>

                <li>
                    <a href="#manage-courses" data-tab="manage-courses"><i class="fa fa-cog" aria-hidden="true"></i> Manage Courses </a>
                </li>
            </ul>

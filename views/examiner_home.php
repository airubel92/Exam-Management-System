    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            <div class="sidebar-header">
                <img src="https://upload.wikimedia.org/wikipedia/en/thumb/6/6b/United_International_University_Monogram.svg/1200px-United_International_University_Monogram.svg.png" width="150px" alt="UIU" />
            </div>

            <ul class="list-unstyled components">
                <li class="active">
                    <a href="#home" data-tab="home"><i class="fa fa-home" aria-hidden="true"></i> Home </a>
                    <meta name="viewport" content="width=device-width, initial-scale=1">
                </li>

                <li>
                    <a href="#exams" data-tab="exams"><i class="fa fa-user-circle-o" aria-hidden="true"></i> Manage Exams <span class="notification"> <span>
                    </a>
                </li>

                <li>
                    <a href="#gradebook" data-tab="gradebook"><i class="fa fa-cog" aria-hidden="true"></i> Gradebook <span class="notification">
                    </a>
                </li>
            </ul>
            ...
            <div class="logout-section text-center">
                <button class="btn btn-lg logout">
                    <a href="helpers/logout.php"><i class="fa fa-sign-out" aria-hidden="true"></i> Logout </a>
                </button>
            </div>
